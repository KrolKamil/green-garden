...
export class AddUserBaseAndWorkspaceModels1603390872545 implements MigrationInterface {
    name = 'AddUserBaseAndWorkspaceModels1603390872545'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "workspace" ("id" character varying NOT NULL, CONSTRAINT "PK_ca86b6f9b3be5fe26d307d09b49" PRIMARY KEY ("id"))`, undefined);
