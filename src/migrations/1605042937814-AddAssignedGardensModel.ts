...
export class AddAssignedGardensModel1605042937814 implements MigrationInterface {
    name = 'AddAssignedGardensModel1605042937814'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "assigned_gardens" ("id" character varying NOT NULL, "assigned_at" date NOT NULL, "unassigned_at" date, "user_base_id" character varying, "garden_id" character varying, CONSTRAINT "PK_094c03d851a06775cc99416219b" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "assigned_gardens" ADD CONSTRAINT "FK_93d6a1c55c32207c825cb038503" FOREIGN KEY ("garden_id") REFERENCES "garden"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
    }
